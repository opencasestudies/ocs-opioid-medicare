...
p <- ggplot(data = map2015) + 
      geom_polygon(aes(x = long, y = lat, 
                       fill = state.opioid.prescribing.rate,
                       group = group), 
                   color = "white") + 
      coord_quickmap() 
...
p + theme_bw() + 
    ...
    xlab("") + 
    ylab(" ") +
    scale_fill_gradient(breaks = seq(3,9,by = 1)) +
    labs(fill = "Opioid Prescrition Rate\n",
...
p1+ theme_bw() + 
    ...
    xlab("") + 
    ylab(" ") +
    scale_fill_gradient(breaks = seq(100,350,by = 50)) +
    labs(fill = "# of opioid claims per 100 enrollment\n",
         x = "Longitude", y = "Latitude") 
